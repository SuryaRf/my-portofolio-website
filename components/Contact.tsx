...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // OPSI 1: FormSubmit (Paling Mudah)
      const response = await fetch("https://formsubmit.co/ajax/suryarahmatfatahillah@gmail.com", {
        method: "POST",
        headers: {
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            >
                ...
                <div className="space-y-4">
                  {contactInfo.map((info, index) => (
                    <motion.a
                      ...
                      className="flex items-center gap-4 p-4 bg-white/5 backdrop-blur-sm rounded-lg border border-white/10 hover:border-purple-500/50 transition-colors group"
                    >
              ...
              <div>
                <h3 className="text-xl font-bold mb-4">Get to Know Me Better</h3>
                <p className="text-gray-400 text-sm mb-4">
                  Check out my social media to learn more about me and my work
                </p>
                <div className="flex gap-4">
                  {socialLinks.map((social, index) => (
                    <motion.a
                      ...
                      className="p-3 bg-white/5 backdrop-blur-sm rounded-lg border border-white/10 hover:border-purple-500/50 text-gray-400 hover:text-purple-400 transition-colors"
                    >
                      {social.icon}
                    </motion.a>
                  ))}
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <motion.button
                  ...
                  className="w-full px-8 py-4 bg-gradient-to-r from-purple-500 to-blue-500 rounded-lg text-white font-medium shadow-lg hover:shadow-purple-500/50 transition-shadow disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
                >
